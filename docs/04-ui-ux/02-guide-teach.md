...
> [`../01-nen-tang/01-nghiep-vu.md §6`](../01-nen-tang/01-nghiep-vu.md) và [`../03-co-che/01-kho-y-tuong.md` A8].
...
- Gói build là **`com.ductranxuan.gravityjelly`** (đã bỏ flavor demo — chỉ còn `debug`/`release`).
  Để xem lại popup từ đầu khi đang chỉnh, reset cờ bằng `adb shell pm clear com.ductranxuan.gravityjelly`
  (mất best/settings local).
