...
> Nguồn dữ liệu mục tiêu: `docs/levels/goal-system-v2.md`, `docs/levels/world-01-dong-co.md`,
> `docs/level-design-100-levels.xlsx`.
...
E) BOSS — BOSS_COMBO: bào máu boss bằng COMBO. Mỗi lần combo chạm mức mới ≥ ×2 gây (bậc − 1) sát
   ...
   - L20 "Kẻ Đổ Rác" — máu 8 (mỗi lượt đổ dải lá/rác vào cạnh bàn).
...
- (Tuỳ boss) chỉ báo đòn: L20 "sắp đổ rác", L30 "sắp đảo trọng lực (đếm 3→0)".
Dựng 3 ví dụ máu: 5 (Chú Sâu Đồng Cỏ) · 8 (Kẻ Đổ Rác) · 10 (Thần Thác), kèm trạng thái vừa trúng đòn.
