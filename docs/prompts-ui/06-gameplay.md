...
**Design / spec nguồn:**
- Luật Endless: `docs/prompts-claude-code-endless.md` (mục "Luật Endless") + `CLAUDE.md` gốc repo.
...
Đọc trước: core/.../EndlessEngine.kt, Grid.kt, Placement.kt, GravityRotation.kt; docs/prompts-claude-code-endless.md (luật).
...
Đọc trước: app/.../ads/AdsManager.kt, AdsConfig.kt; docs/business-understanding.md (vị trí ad: interstitial theo sự kiện, rewarded hồi sinh/x2); Dialog (file 02/Prompt7).
