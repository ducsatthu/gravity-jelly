...
Tài liệu kiến trúc dự án. Đầu vào: [`business-understanding.md`](business-understanding.md) và [`technical-approach.md`](technical-approach.md). Mục tiêu: chốt **cấu trúc dự án**, **tiêu chuẩn code**, và **rules** trước khi viết dòng code đầu tiên. Chưa triển khai code ở đây.
...
> Tài liệu này định khung **trước khi code**. Khi bắt đầu hiện thực theo lộ trình (`technical-approach.md` §10), mỗi bước phải soi lại Mục 4 (Rules) như checklist review.
