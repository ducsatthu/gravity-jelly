...
Cập nhật 01/07/2026 theo **hệ mục tiêu v2** (`goal-system-v2.md`). World 1 = **TUTORIAL WORLD**:
...
- **Mục tiêu = TRIGGER (hành động đã xảy ra) / điểm / boss** — luôn khả thi, kiểm chứng bằng event.
  Bỏ hẳn `clear_all` (không tự sinh/xác nhận được nghiệm — xem `goal-system-v2.md §1`).
...
➡️ Tiếp theo: World 2 · Rừng rậm (L11–L20) — **thực chiến** + cơ chế **dây leo mọc lan** (xem `goal-system-v2.md §8–11`).
