...
Bộ prompt để vẽ **mockup minh hoạ từng cơ chế** trong `../03-co-che/01-kho-y-tuong.md` bằng Claude Design, nhằm tinh chỉnh cảm giác/giao diện. Mỗi cơ chế = **một thẻ Trước → Sau**, không gắn level cụ thể.
...
*Pool ý tưởng nguồn: `../03-co-che/01-kho-y-tuong.md`. Tokens & style: `design/Gravity Jelly Design System/uploads/00-shared-index.md`. Khi chốt cơ chế nào, có thể gắn vào màn cụ thể ở `docs/02-thiet-ke-man/`.*
