# Hệ mục tiêu — bỏ "Dọn sạch", spec chi tiết màn 1–10

Cập nhật 01/07/2026. Thay thế cách chấm mục tiêu cũ trong `../06-du-lieu/01-thiet-ke-100-man.xlsx`.
...
> **NGUỒN THẬT chi tiết từng màn = `04-world-1-dong-co.md`** (board/khay/giải/cờ ⚠). Mục này là bản
> tóm tắt; khi lệch, lấy `04-world-1-dong-co.md` làm chuẩn.
...
⚠️ LIỆU NGHIỆM (chi tiết ở `04-world-1-dong-co.md` §L5).
...
⚠️ LIỆU NGHIỆM CAO (chi tiết ở `04-world-1-dong-co.md` §L7).
...
= `bậc − 1` mỗi lần chạm mức mới (xem §3). Cộng dồn đủ **5 sát thương** là hạ boss.
...
Cập nhật 02/07/2026. W2 **không dạy mới** (W1 đã dạy hết) — đây là **world
...
Cập nhật 02/07/2026 — redesign thác nước. Bản sắc: **thác đổ = dẫn nước phá giọt**. Khác
...
Archetype **Lõi Giáp** (03-campaign-vo-han.md mục 11, archetype C) — khác W2 (Thần Rừng) & W3 (Thần Thác).
...
- **04/07/2026** — Bỏ nhãn phiên bản "v2/v3" trong tiêu đề và dòng cập nhật (mỗi tài liệu chỉ giữ 1 bản latest). Gộp trùng: công thức sát thương/hồi-xoay chỉ định nghĩa đủ 1 lần ở §3 (nguồn luật: `../01-nen-tang/01-nghiep-vu.md §6` + `02-combo.md §4`), các boss/nơi khác chỉ trỏ về. Ghi chú ⚠ LIỆU NGHIỆM L5/L7 rút thành cờ trỏ `04-world-1-dong-co.md`.
