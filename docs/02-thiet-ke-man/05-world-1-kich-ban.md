...
Cập nhật 02/07/2026. **Nguồn thật** = `04-world-1-dong-co.md` (board/khay/giải). File này là
**playthrough beat-by-beat** cho nhóm art/UX/QA, khớp curriculum thật. Đọc kèm `02-he-muc-tieu.md`
(hệ mục tiêu) và `../04-ui-ux/02-guide-teach.md` (popup dạy-1-lần).
...
⚠️ **LIỆU NGHIỆM CAO** — cần chơi thử (chi tiết ở `04-world-1-dong-co.md` §L7).
...
- **04/07/2026** — Rút ghi chú ⚠ LIỆU NGHIỆM CAO (L7) thành cờ QA ngắn trỏ `04-world-1-dong-co.md §L7`, bỏ chép lại lý do kỹ thuật (nguồn thật ở `04`).
