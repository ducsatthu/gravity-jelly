...
- **Cụm boss** — [`BossCard / BossIntroCard / BossToast`](03-components/09-boss-hud/boss-hud.card.html) — mỗi boss có silhouette jelly riêng (sâu / túi rác / thác nước), chỉ có mắt; card compact (mascot tràn trái + thanh **Khiên** + chip rule/tell), intro card lớn + CTA "Chơi", warning toast; 3 boss.
