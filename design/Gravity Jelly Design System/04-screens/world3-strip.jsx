...
(function () {
  ...
  const NODES = [
    { id: 21, x: 220, y: 1080, kind: 'reg',      state: 'done',   stars: 3, color: 'yellow' }, // first R bend
    { id: 22, x: 108, y:  990, kind: 'reg',      state: 'done',   stars: 3, color: 'mint'   }, // L bend
    { id: 23, x: 243, y:  890, kind: 'reg',      state: 'done',   stars: 2, color: 'pink'   }, // R bend
    { id: 24, x: 116, y:  800, kind: 'reg',      state: 'open'   },                            // L bend
    { id: 25, x: 250, y:  695, kind: 'reg',      state: 'locked' },                            // R bend
    { id: 26, x: 112, y:  600, kind: 'breather', state: 'locked' },                            // L bend
    { id: 27, x: 248, y:  505, kind: 'reg',      state: 'locked' },                            // R bend
    { id: 28, x: 112, y:  435, kind: 'reg',      state: 'locked' },                            // L bend
    { id: 29, x: 248, y:  375, kind: 'reg',      state: 'locked' },                            // R bend
    { id: 30, x: 118, y:  298, kind: 'boss',     state: 'locked' },                            // last bend, closer to gate
  ];
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M3 17c3-3.5 5-3.5 8.5 0s5.5 0 8.5-3.5" fill="none" stroke="#FFFFFF" strokeWidth="2.4" strokeLinecap="round" />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.05, gap: 1 }}>
          ...
          }}>CỔNG · THẾ GIỚI 4</span>
          <span style={{
            fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 15,
            color: '#B9802E', lineHeight: 1.05,
          }}>Sa mạc</span>
        </div>
        <div style={{
  ...
  function World3Strip() {
    return (
      <div style={{
        ...
        {/* Painted river + winding road + gate backdrop */}
