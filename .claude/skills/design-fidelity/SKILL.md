...
- **Text UI luôn đa ngôn ngữ**: thêm/sửa bất kỳ chữ hiển thị nào → dùng `stringResource`, KHÔNG
  hardcode tiếng Việt. Đọc kèm **skill `i18n`** (res/values*, markup màu, `:core` dùng khoá).
